...
**Versión 1 — 9 de julio de 2026 — aprobada por el director (Leo)**
...
- Fase actual: **Fase 0** (péndulo). Estado: cimientos completos, falta el primer video del director.
- Próxima acción concreta: cuando exista el video, escribir `registros/prerregistro-01.md`, extraer posiciones con OpenCV, correr PySR con los parámetros de la sección 3b de CIMIENTOS.md.
- Preguntas abiertas priorizadas: ninguna aún — nacen de los nodos (Regla 18).
