...
| `ARBOL.md` | El único mapa que queda dentro: el diagrama de sus nodos y sus preguntas abiertas | El orquestador tras cada hito, con los guardianes verdes | Humanos y, como mapa, Diego (Regla 29) | **NO directamente** — refleja lo que las hojas ya prueban; `coherencia.py` verifica que no proclame nada sin respaldo en disco |
| ~~`GIMNASIO.md`, `GENOMA-DIEGO.md`~~ → **`registros/`** | **MUDADOS el 10-ago-2026** por orden del director (*"evita que todo cartel esté dentro de las hojas"*). Esta tabla los llamaba "mapas" y los dejaba del lado de Diego, pero los dos **citan ciencia humana por su nombre** — `GIMNASIO.md` es una revisión de literatura cuyo propio §1 advertía que nada de eso podía llegar a él. Eran carteles vestidos de mapa | — | Solo humanos, al otro lado del cortafuegos | **NO.** Y ya no puede volver: `coherencia.py` los tiene en la lista, y además lee **el contenido** de toda hoja `.md` buscando citas de ciencia humana |
