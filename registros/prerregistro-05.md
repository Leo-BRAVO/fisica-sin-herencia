...
- **Qué se corre:** `transferir.py` toma las ecuaciones de la mejor semilla oficial del Trial 1 (semilla 9, error 0.1461) tal cual están escritas — sin tocar una sola constante — y las evalúa sobre el 30% temporal oculto de los Trials 2 y 3.
